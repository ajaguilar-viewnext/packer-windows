...
if exist C:\Users\infinityuser\.vagrant.d\Vagrantfile goto :have_vagrantfile
if exist C:\vagrant\resources\Vagrantfile-global (
  copy C:\vagrant\resources\Vagrantfile-global C:\Users\infinityuser\.vagrant.d\Vagrantfile
)
:have_vagrantfile
